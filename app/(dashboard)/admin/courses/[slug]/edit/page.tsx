...
import { getCourseAdmin, updateCourse } from '@/app/actions/course';
import Link from 'next/link';
import ThumbnailUploadForm from '@/app/components/admin/ThumbnailUploadForm';
...
export default async function EditCoursePage(props: Props) {
    ...
    async function handleUpdate(formData: FormData) {
        ...
        if (thumbnailBase64) {
            const { replaceCourseThumbnailFromBase64 } = await import('@/app/actions/course');
