...
import { getCurrentUserWithRole } from '@/app/lib/auth';
...
import PendingSubscriptionsAlert from '@/app/components/admin/PendingSubscriptionsAlert';
import RecentUsersTable from '@/app/components/admin/RecentUsersTable';
import RecentActivityList from '@/app/components/admin/RecentActivityList';
import TopCoursesList from '@/app/components/admin/TopCoursesList';
import SystemStatusCard from '@/app/components/admin/SystemStatusCard';
import SupportCard from '@/app/components/admin/SupportCard';
...
export default async function AdminDashboardPage() {
  ...
  // Require admin role
  if (user.role !== 'admin') {
  redirect('/dashboard'); // Only redirect if not admin
}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/admin/users">
            <div className="group bg-white rounded-xl border border-gray-200 p-5 hover:border-indigo-300 hover:shadow-lg transition-all duration-300 cursor-pointer">
              ...
              <h3 className="text-base font-semibold text-gray-900 mb-1">User </h3>
          ...
          <Link href="/admin/courses">
            <div className="group bg-white rounded-xl border border-gray-200 p-5 hover:border-purple-300 hover:shadow-lg transition-all duration-300 cursor-pointer">
              ...
              <h3 className="text-base font-semibold text-gray-900 mb-1">Course </h3>
              <p className="text-sm text-gray-600">Create and edit</p>
            </div>
          </Link>
